...
// import { DocumentsForm } from "../components/Documents/DocumentsForm.jsx";
const props = {
  deleteDocuments() {},
  actions: {
...
it ('should have errors message', () => {
  expect(wrapper.state().errors.title). toBe('Title must be at least 6 characters!');
});
